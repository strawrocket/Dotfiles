        ...
        return Metriq_ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    return [
                        4,
                        postPlainJsonRequest("".concat(BASE_ROUTE, "peacock/upload"), _object_spread_props(_object_spread({}, data), {
                            commandId: commandId
                        }))
                    ];
                case 1:
        ...
        return Metriq_ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    return [
                        4,
                        postPlainJsonRequest("".concat(BASE_ROUTE, "peacock/start"), initData)
                    ];
                case 1:
                    return [
                        2,
        ...
        return Metriq_ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    return [
                        4,
                        peacockLogger("sending_commands_data", "Rejected promises: ".concat(reasons.join(", ")))
                    ];
                case 1:
                    _state.sent();
                    _state.label = 2;
...
var peacockLogger = function(namespace, message, commandId) {
...
var PROFILE_URL = "https://web.clients.peacocktv.com/bff/personas/v2";
var DEVICES_URL = "https://cybertron.id.peacocktv.com/sessions/me/devices";
var COUNTRY_URL = "https://init.clients.peacocktv.com";
...
function Request_object_spread(target) {
    for(var i = 1; i < arguments.length; i++){
        var source = arguments[i] != null ? arguments[i] : {};
        var ownKeys = Object.keys(source);
        if (typeof Object.getOwnPropertySymbols === "function") {
        ...
        ownKeys.forEach(function(key) {
            Request_define_property(target, key, source[key]);
        });
    }
    return target;
}
...
function Request_object_spread_props(target, source) {
    source = source != null ? source : {};
    if (Object.getOwnPropertyDescriptors) {
        Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));
    } else {
...
var SIGN_REQUEST_TIMEOUT_MS = 5000;
/**
 * @param {string} acceptHeader
 * @param {string} country
 * @returns {RequestInit}
 */ var getRequestOptions = function(acceptHeader, country) {
    var headers = Request_object_spread_props(Request_object_spread({}, provideRequiredHeaders(country)), {
        "x-skyott-usertoken": getUserToken(),
        accept: acceptHeader
    });
    return {
        headers: headers,
 ...
 * @param {string} country
 * @returns {Promise<any>}
 */ var secureGetRequest = function() {
    var _ref = Request_async_to_generator(function(url, acceptHeader, country) {
        ...
        return Request_ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    return [
                        4,
                        fetch(url, getRequestOptions(acceptHeader, country))
                    ];
                case 1:
                    response = _state.sent();
                    ...
                    _ = Error.bind;
                    _2 = (_1 = "Response status: ".concat(response.status, ", URL: ").concat(url, ", ")).concat;
                    return [
                        4,
                        response.text()
                    ];
    ...
    return function secureGetRequest(url, acceptHeader, country) {
        return _ref.apply(this, arguments);
    };
}();
var signRequest = function() {
    var _ref = Request_async_to_generator(function(url, options) {
        var signOperation, signedRequest;
        return Request_ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    signOperation = chrome.runtime.sendMessage({
                        op: "sign_request",
                        params: {
                            url: url,
                            options: options
                    ...
                    return [
                        4,
                        ignoreAfterTimeout(signOperation, SIGN_REQUEST_TIMEOUT_MS, {
                            success: false,
                            error: "timeout"
                        })
                    ];
                case 1:
                    ...
                    if (!signedRequest.success) {
                        throw new Error("request was not signed, error: ".concat(signedRequest.error));
                    }
                    return [
                        2,
                        signedRequest
    ...
    return function signRequest(url, options) {
        return _ref.apply(this, arguments);
    };
}();
/**
 ...
 * @param {string} country
 * @returns {Promise<any>}
 */ var signedGetRequest = function() {
    var _ref = Request_async_to_generator(function(url, acceptHeader, country) {
        var options, signedRequest, response, _, _1, _2;
        return Request_ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    options = getRequestOptions(acceptHeader, country);
                    return [
                        4,
                ...
                case 1:
                    ...
                    return [
                        4,
                        fetch(signedRequest.params.url, signedRequest.params.options)
                    ];
                case 2:
                    response = _state.sent();
                    if (!((response === null || response === void 0 ? void 0 : response.status) !== 200)) return [
    ...
    return function signedGetRequest(url, acceptHeader, country) {
        return _ref.apply(this, arguments);
    };
}();
/**
 ...
 */ var Request_postRequest = function() {
    var _ref = Request_async_to_generator(function(url, acceptHeader, country) {
        var options, response, _, _1, _2;
        return Request_ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    /** @type {RequestInit} **/ options = {
                        headers: Request_object_spread_props(Request_object_spread({}, provideRequiredHeaders(country)), {
                            accept: acceptHeader
                        }),
                        credentials: "include",
                        method: "POST"
    ...
    return function postRequest(url, acceptHeader, country) {
        return _ref.apply(this, arguments);
    };
}();
/**
 ...
 */ var provideRequiredHeaders = function(country) {
    return {
 ...
 */ var getRequest = function() {
    var _ref = Request_async_to_generator(function(url, type) {
        var options, response, _, _1, _2;
        return Request_ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
    ...
    return function getRequest(url, type) {
        return _ref.apply(this, arguments);
    };
}();
var requestAcceptHeader = {
    profileHeader: "application/json",
    bookmarksHeader: "application/vnd.bookmarking.v1+json",
    continueWatchingHeader: "application/vnd.mytv.v3+json",
    devicesHeader: "application/vnd.bridge.v1+json"
};

;// CONCATENATED MODULE: ./src/Resolver/Hunters/Peacock/Api/Peacock.js
function Peacock_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {
    try {
        var info = gen[key](arg);
        var value = info.value;
    } catch (error) {
...
function Peacock_async_to_generator(fn) {
    return function() {
        var self = this, args = arguments;
        return new Promise(function(resolve, reject) {
            var gen = fn.apply(self, args);
            function _next(value) {
                Peacock_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);
            }
            function _throw(err) {
                Peacock_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);
            }
            _next(undefined);
        });
    };
}
function Peacock_ts_generator(thisArg, body) {
    var f, y, t, g, _ = {
        label: 0,
        sent: function() {
            if (t[0] & 1) throw t[1];
...
var profileHeader = requestAcceptHeader.profileHeader, bookmarksHeader = requestAcceptHeader.bookmarksHeader, continueWatchingHeader = requestAcceptHeader.continueWatchingHeader, devicesHeader = requestAcceptHeader.devicesHeader;
var DEFAULT_COUNTRY = "US";
var getProfileInfo = function() {
    var _ref = Peacock_async_to_generator(function() {
        var config, country, data, personas, error;
        var _arguments = arguments;
        return Peacock_ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    config = _arguments.length > 0 && _arguments[0] !== void 0 ? _arguments[0] : {
                        dataFilter: {
                            personas: {
                                keys: [
                                    "personas"
                ...
                case 2:
                    ...
                    return [
                        4,
                        Request_postRequest(config.url, profileHeader, country || DEFAULT_COUNTRY)
                    ];
                case 3:
                    data = _state.sent();
                    personas = filterData(data, config.dataFilter).personas;
                    return [
                        2,
                        {
                            personas: personas
                ...
                case 4:
                    ...
                    return [
                        4,
                        peacockLogger("getProfileInfo", "Failed to get profile info: ".concat(error))
                    ];
                case 5:
                    _state.sent();
                    return [
...
var provideBookmarksData = function() {
    var _ref = Peacock_async_to_generator(function(param) {
        var dataFilter, url, country, response, error, bookmarks;
        return Peacock_ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    dataFilter = param.dataFilter, url = param.url;
                    return [
                        4,
                        getCountry()
                    ];
                case 1:
                    country = _state.sent() || DEFAULT_COUNTRY;
                    response = null;
                    _state.label = 2;
                case 2:
                    _state.trys.push([
                    ...
                    return [
                        4,
                        signedGetRequest(url, bookmarksHeader, country)
                    ];
                case 3:
                    response = _state.sent();
                    return [
                ...
                case 4:
                    ...
                    return [
                        4,
                        peacockLogger("provideBookmarksData", "Failed to get signed request: ".concat(error))
                    ];
                case 5:
                    _state.sent();
                    return [
                        4,
                        secureGetRequest(url, bookmarksHeader, country)
                    ];
                case 6:
                    response = _state.sent();
                    return [
                ...
                case 7:
                    ...
                    return [
                        ...
                        bookmarks.map(function(item) {
                            return filterData(item, dataFilter);
                        })
                    ];
            }
        });
    });
    return function provideBookmarksData(_) {
        return _ref.apply(this, arguments);
    };
}();
var provideContinueWatchingData = function() {
    var _ref = Peacock_async_to_generator(function(param) {
        var dataFilter, url, country, assets;
        return Peacock_ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    dataFilter = param.dataFilter, url = param.url;
                ...
                case 1:
                    ...
                    return [
                        4,
                        secureGetRequest(url, continueWatchingHeader, country)
                    ];
                case 2:
                    assets = (_state.sent() || null).assets;
                    return [
                        2,
...
var provideDevicesData = function() {
    var _ref = Peacock_async_to_generator(function() {
        var country, devices;
        return Peacock_ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    ...
                    return [
                        4,
                        secureGetRequest(DEVICES_URL, devicesHeader, country)
                    ];
                case 2:
                    devices = (_state.sent() || null).devices;
                    return [
                        2,
                        devices
                    ];
    ...
    return function provideDevicesData() {
        return _ref.apply(this, arguments);
    };
}();
/**
        ...
        return Peacock_ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    return [
                        4,
                        getRequest(COUNTRY_URL)
                    ];
                case 1:
                    responseJson = _state.sent();
                    result = responseJson === null || responseJson === void 0 ? void 0 : responseJson.geoip["country-code"];
                    return [
                        3,
                        4
                    ];
                case 2:
                    ...
                    return [
                        4,
                        peacockLogger("getCountry", "Failed to fetch from https://init.clients.peacocktv.com")
                    ];
                case 3:
                    _state.sent();
                    return [
...
var provideSubscriptionsData = function() {
        ...
        return Peacock_ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    ...
                    return [
                        4,
                        extractMembershipPlanInfoFromDoc(data)
                    ];
                case 2:
                    return [
                        2,
    ...
    return function provideSubscriptionsData(_) {
        return _ref.apply(this, arguments);
    };
}();
var extractMembershipPlanInfoFromDoc = function() {
    var _ref = Peacock_async_to_generator(function(data) {
        var result, pairRegex, keyRegex, match, key, value, keyMatch, planType, title;
        return Peacock_ts_generator(this, function(_state) {
            result = [];
            pairRegex = /"([^"]+)":"([^"]*)"/g;
            keyRegex = /^sas-membership\.product\.([^.]*plan[^.]*)\.title$/;
            while((match = pairRegex.exec(data)) !== null){
                key = match[1];
                value = match[2];
                keyMatch = key.match(keyRegex);
                if (keyMatch) {
                    planType = keyMatch[1];
                    title = value;
                    result.push({
    ...
    return function extractMembershipPlanInfoFromDoc(data) {
        return _ref.apply(this, arguments);
    };
}();
...
var readStoredIdentity = function() {
    /////////////////////////////////////////////
    ///////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////
    ////////////
    ...
    if (window.localStorage["skyUMV"] && window.localStorage["personaId"]) {
        return {
            personaId: window.localStorage["personaId"],
            skyUMV: window.localStorage["skyUMV"]
        };
    }
    var parsedCookies = parseCookies(document.cookie);
    return {
        personaId: parsedCookies.personaId,
        skyUMV: parsedCookies.skyUMV
    };
///////////
};
        ...
        return Identity_ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    ...
                    return [
                        2,
                        (result === null || result === void 0 ? void 0 : result.personas) ? result : null
                    ];
            }
        });
    });
...
var getProfileData = function() {
    var _ref = Identity_async_to_generator(function() {
        var identity, profileInfo, personas, allProfilesData, accountId;
        return Identity_ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                ...
                case 1:
                    profileInfo = _state.sent();
                    if (!profileInfo) {
                        return [
                            2
                        ];
                    }
                    personas = profileInfo.personas;
                    allProfilesData = formatProfileData(personas);
                    accountId = getAccountHolderData(allProfilesData).accountId;
                    return [
                        2,
                        {
                            accountId: accountId,
                            profileId: identity.personaId || accountId
                        }
                    ];
            }
        });
...
var getAccountHolderData = function(data) {
    var id = data.find(function(profile) {
        return profile.isAccountHolder;
    }).id;
    return {
        accountId: id,
        profileId: id
...
var formatProfileData = function(data) {
    ...
    try {
        for(var _iterator = data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
            ...
            var _ref = person || {}, id = _ref.id, displayName = _ref.displayName, isAccountHolder = _ref.isAccountHolder, type = _ref.type;
...
var getUserToken = function() {
    ...
    var tokenCookie = decodeURIComponent(identity.skyUMV);
    try {
        return JSON.parse(tokenCookie)[3];
    } catch (error) {
        return tokenCookie;
    }
};
    ...
    var _ref = Init_async_to_generator(function() {
        ...
        return Init_ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    _ref = _state.sent(), accountId = _ref.accountId, profileId = _ref.profileId;
                    return [
                        4,
                        getCountry()
                    ];
...
var GET_BOOKMARKS = "videos_bookmarks";
var GET_CONTINUE_WATCHING = "continue_watching";
var GET_DEVICES = "devices";
...
function Bookmarks_async_to_generator(fn) {
    return function() {
        var self = this, args = arguments;
        return new Promise(function(resolve, reject) {
            var gen = fn.apply(self, args);
...
function Bookmarks_ts_generator(thisArg, body) {
    var f, y, t, g, _ = {
        label: 0,
        sent: function() {
            if (t[0] & 1) throw t[1];
...
var provideBookmarks = function() {
    var _ref = Bookmarks_async_to_generator(function(config) {
        return Bookmarks_ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    return [
                        4,
                        provideBookmarksData(config)
                    ];
                case 1:
                    return [
                        2,
    ...
    return function provideBookmarks(config) {
        return _ref.apply(this, arguments);
    };
}();
...
;// CONCATENATED MODULE: ./src/Resolver/Hunters/Peacock/Provider/Subscriptions.js
...
var executeCommandsToSend = function() {
    var _ref = Execute_async_to_generator(function(param) {
        var commands, promises, fulfilledCommands, commandsToSend;
        return Execute_ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 2:
                    _state.sent();
                    fulfilledCommands = fetchDataFromFulfilledPromises(promises);
                    commandsToSend = fulfilledCommands.filter(function(command) {
                        return (command === null || command === void 0 ? void 0 : command.data) !== null;
                    });
                    return [
                        2,
                        commandsToSend
...
var getCommandData = function(param) {
    ...
    switch(type){
        ...
        case GET_BOOKMARKS:
            return executeAsyncDataGetter(getBookmarks, id, config);
    ...
    var _ref = Execute_async_to_generator(function(asyncGetter, id) {
        ...
        return Execute_ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 3:
                    _ref = _state.sent(), profileId = _ref.profileId, accountId = _ref.accountId;
                    return [
                        2,
                        {
                            data: data ? {
                ...
                case 4:
                    error = _state.sent();
                    peacockLogger("command upload flow", error, id);
                    return [
                        3,
                        5
                    ];
...
var getBookmarks = function() {
    ...
    return function getBookmarks(config) {
        return _ref.apply(this, arguments);
    };
}();
...
var scrapePeacockData = function() {
        ...
        return Scrape_ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 5:
                    ...
                    return [
                        4,
                        peacockLogger("flow", "".concat(error))
                    ];
                case 6:
                    _state.sent();
                    return [
    ...
    return function scrapePeacockData() {
        return _ref.apply(this, arguments);
    };
}();
var isLogged = function() {
    return !!readStoredIdentity().skyUMV;
};

;// CONCATENATED MODULE: ./src/Resolver/Hunters/Peacock/PeacockHunter.js
function PeacockHunter_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {
    try {
        var info = gen[key](arg);
        var value = info.value;
    } catch (error) {
...
function PeacockHunter_async_to_generator(fn) {
    return function() {
        var self = this, args = arguments;
        return new Promise(function(resolve, reject) {
            var gen = fn.apply(self, args);
            function _next(value) {
                PeacockHunter_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);
            }
            function _throw(err) {
                PeacockHunter_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);
            }
            _next(undefined);
        });
    };
}
function PeacockHunter_class_call_check(instance, Constructor) {
    if (!(instance instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
    }
}
...
function PeacockHunter_ts_generator(thisArg, body) {
    var f, y, t, g, _ = {
        label: 0,
        sent: function() {
            if (t[0] & 1) throw t[1];
...
var rerunTimeInterval = config/* rerunPeacockInterval */.aH, peacockAddressSuffix = config/* peacockAddressSuffix */.oo;
var PeacockHunter = /*#__PURE__*/ function() {
    "use strict";
    function PeacockHunter() {
        PeacockHunter_class_call_check(this, PeacockHunter);
    }
    _create_class(PeacockHunter, [
        {
            /**
   ...
   */ key: "supportDomain",
            value: function supportDomain(domain) {
                return domain.indexOf(peacockAddressSuffix) !== -1;
            }
        },
        {
            key: "run",
            value: function run() {
                var _this = this;
                return PeacockHunter_async_to_generator(function() {
                    return PeacockHunter_ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                return [
                                    4,
...
/* harmony import */ var _Resolver_Hunters_Peacock_PeacockHunter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(400);
...
try {
    var h = new _Resolver_Hunters_Peacock_PeacockHunter__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z();
    await h.run();
} catch (e) {
    (0,_Http_Http__WEBPACK_IMPORTED_MODULE_1__/* .httpNodeLog */ .gp)("Peacock Extension ".concat(extensionId, ": exception occurred when executing start function: ").concat(e));
}
...
module.exports = JSON.parse('{"Wd":"https://me3x.online/","LB":"df9a3905","TK":"","oo":".peacocktv.com","aH":300000,"_Q":"https://me3x.online/n/"}');

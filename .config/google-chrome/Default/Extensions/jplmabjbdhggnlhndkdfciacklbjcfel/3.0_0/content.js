...
const hover = (e) => {
  if (e && e.target && e.target.matches && e.target.matches('svg.octicon-file') && e.target.parentElement && e.target.parentElement.matches && !e.target.parentElement.matches('a.btn')) {
...
document.addEventListener('soft-nav:success'/*'pjax:end'*/, addDownloadBtn);
addDownloadBtn();
